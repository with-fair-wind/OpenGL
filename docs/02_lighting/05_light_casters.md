...
| 0.966 | 15° | 0.976 | 12.5° | 0.953 | 17.5° | 0.976 − 0.953 = 0.023 | (0.966 − 0.953) / 0.023 ≈ 0.56 |

（$I$ 列的分母为 $\epsilon$、分子为 $\theta - \gamma$。**译注：** 原文此行把 12.5° 的余弦写作 0.9978，与其正文「cos(12.5°) ≈ 0.976」的表述自相矛盾——0.9978 实为约 4.1° 的余弦。本表已按 cos(12.5°) ≈ 0.976 修正 $\phi$、$\epsilon$ 与 $I$。）你可以看到，我们基本是在内外余弦值之间根据 $\theta$ 插值。如果你仍不明白发生了什么，不必担心，只需要记住这个公式就好了，在你更聪明的时候再回来看看。
